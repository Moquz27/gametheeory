...
\noindent\makebox[\linewidth][c]{\(\displaystyle\sum_i x_i = 1 \quad \text{and} \quad \sum_j y_j = 1 \)}
...
\noindent\makebox[\linewidth][c]{\(\displaystyle \frac1{v'}=\sum_{i=1}^{m}X_i\)}

Therefore, the problem becomes equivalent to minimizing:

\noindent\makebox[\linewidth][c]{\(\displaystyle \sum_{i=1}^{m}X_i\)}
...
\noindent\makebox[\linewidth][c]{\(\displaystyle \sum_{j=1}^{n}a'_{ij}y_j\)}
