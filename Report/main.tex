...
\begin{itemize}
    \item original game value
    \item added positive constant
    \item shifted game value
\end{itemize}
...
\begin{itemize}
    \item is the probability of choosing row strategy \(i\)
    \item \(x_i \ge 0\)
\end{itemize}
...
\begin{itemize}
    ...
    \item \(\sum a'_{ij}x_i\): expected payoff of Player A if Player B selects column \(j\).
\end{itemize}
